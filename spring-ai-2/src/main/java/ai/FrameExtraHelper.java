...
public final class FrameExtraHelper implements ApplicationRunner {
    ...
    private static final File videoUrl = new File(
            "D:\\workspace\\spring-ai\\spring-ai-3\\src\\main\\resources\\multimodel\\dog_and_girl.jpeg");

    private static final String framePath = "D:\\workspace\\spring-ai\\spring-ai-3\\src\\main\\resources\\multimodel\\frame";
    ...
    public static List<Media> createMediaList(int numberOfImages) {
        ...
        for (int i = 0; i < totalFrames; i = i + numberOfImages) {
            Media media = new Media(MimeType.valueOf("image/png"), new PathResource(imgList.get(i)));
            objects.add(media);
        }
        return objects;
    }
