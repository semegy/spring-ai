 ...
 * todo make it a vector store service
 */
@Service
public class CloudRagService implements RagService {
    ...
    public CloudRagService(@Qualifier("qianwen3") ChatModel chatModel, @Qualifier("embeddingModel") EmbeddingModel embeddingModel,
    ...
    public void importDocuments() {
        ...
        try {
            reader = new DashScopeDocumentCloudReader(resource.getFile().getPath(), dashscopeApi, null);
        } catch (IOException e) {
        ...
        // todo: add documents to DashScope cloud storage
