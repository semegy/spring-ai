...
public class MysqlMemoryController {
    ...
    public MysqlMemoryController(@Qualifier("qianwen3") ChatModel chatModel, @Qualifier("mysqlChatMemoryRepository") MysqlChatMemoryRepository mysqlChatMemoryRepository) {
