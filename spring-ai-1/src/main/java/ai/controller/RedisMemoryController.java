...
public class RedisMemoryController {
    ...
    public RedisMemoryController(@Qualifier("qianwen3") ChatModel chatModel, @Qualifier("redisChatMemoryRepository") RedissonRedisChatMemoryRepository redisChatMemoryRepository) {
